...
시뮬레이션처럼 보이는 문제를 풀기 전에, 시뮬레이션을 돌리지 않아도 정답을 찾을 수 있는지 확인하는 게 중요함. - SWEA_2805_농작물수확하기
...
시뮬레이션 문제에서 특정 배열 칸을 이동하는 문제는 방향(dir)과 좌표(x,y)를 뽑아낸 뒤, 배열에서 해당 칸을 일반화시킨 후, 방향과 좌표로 조작함. - SWEA_1873_상호의배틀필드, 아기상어
